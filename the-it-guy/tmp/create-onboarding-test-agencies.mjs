...
const AGENCIES = [
  ...
  {
    key: 'ragstoriches',
    agencyName: 'Rags to Riches',
    tradingName: 'Rags to Riches',
    principalEmail: 'alex.ragstoriches.training@arch9.test',
    businessEmail: 'hello@ragstoriches-onboarding.test',
    principalFullName: 'Alexander Landman',
    principalPhone: '+27 82 000 0206',
    province: 'Gauteng',
    city: 'Johannesburg',
    address: 'Onboarding Test Office, Johannesburg',
    website: 'https://ragstoriches-onboarding.test',
    registrationNumber: 'ONBOARDING-RAGSTORICHES-2026-08-13',
    ppraNumber: 'FFC-RAGSTORICHES-TEST',
    primaryColour: '#6b4f7a',
    secondaryColour: '#2f2538',
    accentColour: '#d5b65a',
  },
  {
    key: 'destinyhomes',
