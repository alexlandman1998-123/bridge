...
const AGENCIES = [
  {
    ...
    tradingName: 'Northpoint Realty',
    principalEmail: 'alex.northpoint.training@arch9.test',
    businessEmail: 'hello@northpoint-onboarding.test',
    principalFullName: 'Alexander Landman',
    principalPhone: '+27 82 000 0101',
    province: 'Western Cape',
    city: 'Cape Town',
    address: 'Onboarding Test Office, Cape Town',
    website: 'https://northpoint-onboarding.test',
    registrationNumber: 'ONBOARDING-NORTHPOINT-2026-08-01',
    ppraNumber: 'FFC-NORTHPOINT-TEST',
    primaryColour: '#24566f',
    secondaryColour: '#163340',
    accentColour: '#d9b95f',
  },
  {
    key: 'harbourline',
    agencyName: 'Bridge9 Harbourline Realty',
    tradingName: 'Harbourline Realty',
    principalEmail: 'alex.harbourline.training@arch9.test',
    businessEmail: 'hello@harbourline-onboarding.test',
    principalFullName: 'Alexander Landman',
    principalPhone: '+27 82 000 0102',
    province: 'KwaZulu-Natal',
    city: 'Durban',
    address: 'Onboarding Test Office, Durban',
    website: 'https://harbourline-onboarding.test',
    registrationNumber: 'ONBOARDING-HARBOURLINE-2026-08-01',
    ppraNumber: 'FFC-HARBOURLINE-TEST',
    primaryColour: '#315d4f',
    secondaryColour: '#18332d',
    accentColour: '#c89f5d',
  },
]
