...
assert.match(route, /<Suspense[\s\S]*?fallback=\{<LeadWorkspaceHydrationShell search=\{location\.search\} \/>\}/)
assert.doesNotMatch(route, /AgencyLeadWorkspaceShellPage/, 'the superseded dark preview must stay out of the route')
