...
const checkedAt = process.env.OTP_STEADY_STATE_GOVERNANCE_MONITORING_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpSteadyStateGovernanceMonitoringPhase44Audit({
  checkedAt,
  phase43Audit,
  packageJson,
})
const outputUrl = new URL('../docs/otp-steady-state-governance-monitoring-phase44.md', import.meta.url)

await writeFile(outputUrl, formatOtpSteadyStateGovernanceMonitoringPhase44Markdown(report), 'utf8')
