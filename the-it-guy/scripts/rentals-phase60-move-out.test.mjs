...
const migration = await read('../supabase/migrations/20260831101607_rental_move_out_workflow.sql')
const indexMigration = await read('../supabase/migrations/20260831101745_rental_move_out_foreign_key_indexes.sql')
...
for (const value of ['Move-out not started', 'Start move-out', 'closure blocker', 'Reschedule outgoing inspection']) assert.ok(page.includes(value), `missing move-out UI ${value}`)
