...
assert.match(pageSource, /Buyer requested 3 possible times/, 'planner should surface the three buyer-submitted preferred viewing options')
...
assert.match(pageSource, /Added to Viewing Planner/, 'planner should show saved manual buyer viewing times as already added to the viewing planner')
