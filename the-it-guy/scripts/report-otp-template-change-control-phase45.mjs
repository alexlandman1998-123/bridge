...
const checkedAt = process.env.OTP_TEMPLATE_CHANGE_CONTROL_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpTemplateChangeControlPhase45Audit({
  checkedAt,
  phase44Audit,
  packageJson,
})
const outputUrl = new URL('../docs/otp-template-change-control-phase45.md', import.meta.url)

await writeFile(outputUrl, formatOtpTemplateChangeControlPhase45Markdown(report), 'utf8')
