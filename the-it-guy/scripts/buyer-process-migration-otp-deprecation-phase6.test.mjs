...
assert.equal(legacyOtpMigration.stageKey, 'transaction_setup')
assert.equal(legacyOtpMigration.stageLabel, 'Transaction Setup')
assert.equal(legacyOtpMigration.statusLabel, 'Transaction Setup')
...
assert.equal(migratedLegacyOtpLead.stage, 'Transaction Setup')
assert.equal(migratedLegacyOtpLead.status, 'Transaction Setup')
assert.equal(migratedLegacyOtpLead.buyerProcessStageKey, 'transaction_setup')
...
assert.match(agencyPipelinePageSource, /Open Transaction Setup/)
...
assert.match(agencyPipelinePageSource, /Opening signed OTP upload/)
