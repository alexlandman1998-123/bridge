...
assert.match(agencyPipelinePageSource, /BUYER_ONBOARDING_OTP_WORKSPACE_TAB_KEY = 'offers'/)
assert.match(agencyPipelinePageSource, /Open Offers/)
assert.match(agencyPipelinePageSource, /label: 'Offers'/)
assert.doesNotMatch(agencyPipelinePageSource, /Open Onboarding \/ OTP/)
