...
const migration = await read('../supabase/migrations/20260831100450_rental_maintenance_execution_reopen.sql'); const repository = await read('src/services/rentals/rentalMaintenanceRepository.js'); const page = await read('src/pages/rentals/RentalMaintenanceExecutionPage.jsx'); const app = await read('src/App.jsx')
