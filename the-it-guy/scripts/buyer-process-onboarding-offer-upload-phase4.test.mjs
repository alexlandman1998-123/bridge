...
assert.match(source, /OTP uploaded and buyer moved to Offer\./)
...
assert.match(source, /buyer-offer-upload-confirmations/)
...
assert.match(source, /creationMode: 'manual_capture'/)
...
assert.match(source, /Confirm the signed OTP is signed by all parties/)
