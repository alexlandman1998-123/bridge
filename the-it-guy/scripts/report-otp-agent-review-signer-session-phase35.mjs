...
const checkedAt = process.env.OTP_AGENT_REVIEW_SIGNER_SESSION_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpAgentReviewSignerSessionPhase35Audit({
  checkedAt,
  phase34Audit,
  signerPortalSource,
...
const outputUrl = new URL('../docs/otp-agent-review-signer-session-phase35.md', import.meta.url)

await writeFile(outputUrl, formatOtpAgentReviewSignerSessionPhase35Markdown(report), 'utf8')
