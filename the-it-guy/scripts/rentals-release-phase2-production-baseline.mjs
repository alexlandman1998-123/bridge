...
import { assessRentalProductionBaselineAuthority } from '../src/services/rentals/rentalProductionBaselineAuthority.js'
...
const report = {
  ...
  evidencePath,
  ...assessRentalProductionBaselineAuthority(JSON.parse(fs.readFileSync(absolutePath, 'utf8'))),
}
