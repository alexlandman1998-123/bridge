...
import { buildRentalManagedMigrationAuthoringWorkOrder } from '../src/services/rentals/rentalManagedMigrationAuthoring.js'
...
const report = { checkedAt: new Date().toISOString(), evidencePath, ...buildRentalManagedMigrationAuthoringWorkOrder(sourceLock) }

console.log(JSON.stringify(report, null, 2))
if (!report.scaffoldAllowed) process.exitCode = 2
