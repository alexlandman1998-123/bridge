...
const checkedAt = process.env.OTP_AGENT_REVIEW_RUNTIME_PROOF_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpAgentReviewRuntimeProofPhase32Audit({
  checkedAt,
  phase31Audit,
  packetServiceSource,
  workspaceSource,
...
const outputUrl = new URL('../docs/otp-agent-review-runtime-proof-phase32.md', import.meta.url)

await writeFile(outputUrl, formatOtpAgentReviewRuntimeProofPhase32Markdown(report), 'utf8')
