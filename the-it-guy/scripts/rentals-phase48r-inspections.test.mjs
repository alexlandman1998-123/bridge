...
for (const value of ['Inspection template', 'Schedule inspection', 'Inspection queue', 'Start', 'incoming','outgoing']) assert.ok(page.includes(value), `missing inspection UI ${value}`)
