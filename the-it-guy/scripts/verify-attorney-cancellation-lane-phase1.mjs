...
assert.equal(map.attorney.stageKeys.length, 22)
assert.equal(map.attorney.mappedStageKeys.length, 22)
...
assert.ok(map.attorney.mappedStageKeys.includes('cancellation_guarantee_allocation_review'))
assert.ok(map.attorney.mappedStageKeys.includes('cancellation_consent_confirmed'))
assert.ok(map.attorney.mappedStageKeys.includes('cancellation_simultaneous_lodgement_confirmed'))
...
assert.equal(guaranteeHandoff?.toStageKey, 'payment_security_review')
