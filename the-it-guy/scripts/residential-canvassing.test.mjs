...
assert.match(canvassingWorkspaceTabsSource, /Current Prospects/, 'canvassing workspace navigation should retain the current prospects workspace')
assert.match(canvassingWorkspaceTabsSource, /Property Search/, 'canvassing workspace navigation should expose property search')
assert.match(canvassingWorkspaceTabsSource, /Property Reports/, 'canvassing workspace navigation should expose property reports')
assert.match(canvassingWorkspaceTabsSource, /aria-label="Canvassing workspaces"/, 'canvassing workspace navigation should identify its purpose to assistive technology')
...
assert.match(canvassingPageSource, /<PropertyDataProviderStatus \/>/, 'Phase 7 should expose provider mode on property search and reports')
