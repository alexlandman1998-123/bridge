...
const checkedAt = process.env.OTP_CONTROLLED_PRODUCTION_CUTOVER_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpControlledProductionCutoverPhase40Audit({
  checkedAt,
  phase39Audit,
  packageJson,
})
const outputUrl = new URL('../docs/otp-controlled-production-cutover-phase40.md', import.meta.url)

await writeFile(outputUrl, formatOtpControlledProductionCutoverPhase40Markdown(report), 'utf8')
