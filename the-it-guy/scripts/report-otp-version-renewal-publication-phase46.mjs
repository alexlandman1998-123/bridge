...
const checkedAt = process.env.OTP_VERSION_RENEWAL_PUBLICATION_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpVersionRenewalPublicationPhase46Audit({
  checkedAt,
  phase45Audit,
  packageJson,
})
const outputUrl = new URL('../docs/otp-version-renewal-publication-phase46.md', import.meta.url)

await writeFile(outputUrl, formatOtpVersionRenewalPublicationPhase46Markdown(report), 'utf8')
