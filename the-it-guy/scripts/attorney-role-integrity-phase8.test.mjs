...
assert.match(migration, /with assignment_slots as/)
assert.match(migration, /cross join lateral/)
assert.match(migration, /null::uuid as member_id,\n  assignment_health\.firm_id/)
assert.match(migration, /where assignment_health\.ineligible_open_assignment_count > 0/)
