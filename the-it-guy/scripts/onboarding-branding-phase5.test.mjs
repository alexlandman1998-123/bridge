...
assert.match(files.sellerService, /sellerOnboarding[\s\S]*portalBranding[\s\S]*mergedBranding/, 'seller onboarding should attach resolved branding to camel-case onboarding payloads')
assert.match(files.sellerService, /seller_onboarding[\s\S]*portal_branding[\s\S]*mergedBranding/, 'seller onboarding should attach resolved branding to snake-case onboarding payloads')
assert.match(files.sellerService, /onboardingFormData\.portal_branding/, 'seller onboarding row mapper should read snake-case portal branding')
assert.match(files.sellerService, /primaryColour: resolvedPortalBranding\.primaryColour/, 'seller onboarding row mapper should expose resolved primary colour at listing level')
assert.match(files.sellerService, /hasBrandColours/, 'seller onboarding branding snapshots should not be dropped when only colours are configured')
...
assert.match(files.sellerOnboarding, /sellerOnboardingFormData\.portal_branding/, 'seller onboarding should read snake-case portal branding from onboarding form data')
