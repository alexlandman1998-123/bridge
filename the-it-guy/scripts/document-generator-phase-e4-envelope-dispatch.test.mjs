...
assert.match(sender, /const requestedResend = booleanFlag\(payload\.resend\) \|\| booleanFlag\(payload\.reminder\)/)
assert.match(sender, /const signerAlreadyActive = \["sent", "viewed"\]\.includes\(signerStatus\)/)
assert.match(sender, /const isResend = requestedResend && signerAlreadyActive/)
