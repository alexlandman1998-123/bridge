...
const checkedAt = process.env.OTP_PRODUCTION_STABILISATION_SIGNOFF_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpProductionStabilisationSignoffPhase42Audit({
  checkedAt,
  phase41Audit,
  packageJson,
})
const outputUrl = new URL('../docs/otp-production-stabilisation-signoff-phase42.md', import.meta.url)

await writeFile(outputUrl, formatOtpProductionStabilisationSignoffPhase42Markdown(report), 'utf8')
