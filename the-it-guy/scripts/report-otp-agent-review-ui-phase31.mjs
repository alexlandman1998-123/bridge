...
const checkedAt = process.env.OTP_AGENT_REVIEW_UI_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpAgentReviewUiPhase31Audit({
  checkedAt,
  phase30Audit,
  workspaceSource,
  packageJson,
})
const outputUrl = new URL('../docs/otp-agent-review-ui-phase31.md', import.meta.url)

await writeFile(outputUrl, formatOtpAgentReviewUiPhase31Markdown(report), 'utf8')
