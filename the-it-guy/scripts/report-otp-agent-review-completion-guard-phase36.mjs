...
const checkedAt = process.env.OTP_AGENT_REVIEW_COMPLETION_GUARD_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpAgentReviewCompletionGuardPhase36Audit({
  checkedAt,
  phase35Audit,
  packetServiceSource,
  packageJson,
})
const outputUrl = new URL('../docs/otp-agent-review-completion-guard-phase36.md', import.meta.url)

await writeFile(outputUrl, formatOtpAgentReviewCompletionGuardPhase36Markdown(report), 'utf8')
