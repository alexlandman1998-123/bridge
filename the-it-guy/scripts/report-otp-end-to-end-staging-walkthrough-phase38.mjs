...
const checkedAt = process.env.OTP_END_TO_END_STAGING_WALKTHROUGH_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpEndToEndStagingWalkthroughPhase38Audit({
  checkedAt,
  phase37Audit,
  packageJson,
})
const outputUrl = new URL('../docs/otp-end-to-end-staging-walkthrough-phase38.md', import.meta.url)

await writeFile(outputUrl, formatOtpEndToEndStagingWalkthroughPhase38Markdown(report), 'utf8')
