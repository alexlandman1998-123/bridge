...
assert.equal(health.counts.missingDocuments, 2)
...
assert.deepEqual(health.exceptions.find((item) => item.taskKey === 'completed-task').reasons.map(reason => reason.code), ['missing_documents'])
