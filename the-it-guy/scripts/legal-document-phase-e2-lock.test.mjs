...
assert.doesNotMatch(workspace, /buildDraftLockSnapshot|lockedByUserId/)
assert.match(a2RuntimeMigration, /drop trigger if exists trg_legal_draft_lock_before_token/)
...
console.log('Legal document E2 legacy audit/A2 runtime compatibility contract passed.')
