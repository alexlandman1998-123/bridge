...
import { assessRentalRecoveryEvidence } from '../src/services/rentals/rentalRecoveryEvidence.js'
...
const report = {
  ...
  evidencePath,
  ...assessRentalRecoveryEvidence(JSON.parse(fs.readFileSync(absolutePath, 'utf8'))),
}
