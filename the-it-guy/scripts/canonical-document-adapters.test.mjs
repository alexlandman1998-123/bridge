...
try {
  ...
  assert.equal(canonicalDefinitionKeyToLegacyKey('signed_addendum'), 'signed_addendum')
  ...
  assert.equal(legacyRequirementKeyToCanonicalKey('signed_addendum'), 'signed_addendum')
