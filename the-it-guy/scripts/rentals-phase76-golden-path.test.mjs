...
const moveOut = await read('../supabase/migrations/20260831101607_rental_move_out_workflow.sql')
const closure = await read('../supabase/migrations/20260831101913_rental_tenancy_closure_and_vacancy.sql')
const screening = await read('../supabase/migrations/20260831102507_rental_screening_operations.sql')
const rollout = await read('../supabase/migrations/20260831103225_rental_controlled_rollout_cohorts.sql')
