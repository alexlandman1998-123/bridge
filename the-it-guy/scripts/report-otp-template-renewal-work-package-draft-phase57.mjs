...
const checkedAt = process.env.OTP_TEMPLATE_RENEWAL_WORK_PACKAGE_DRAFT_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpTemplateRenewalWorkPackageDraftPhase57Audit({
  checkedAt,
  phase56Audit,
  packageJson,
})
const outputUrl = new URL('../docs/otp-template-renewal-work-package-draft-phase57.md', import.meta.url)

await writeFile(outputUrl, formatOtpTemplateRenewalWorkPackageDraftPhase57Markdown(report), 'utf8')
