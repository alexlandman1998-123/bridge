...
const checkedAt = process.env.OTP_TEMPLATE_RENEWAL_PDF_SIGNING_PROOF_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpTemplateRenewalPdfSigningProofPhase61Audit({
  checkedAt,
  phase60Audit,
  packageJson,
})
const outputUrl = new URL('../docs/otp-template-renewal-pdf-signing-proof-phase61.md', import.meta.url)

await writeFile(outputUrl, formatOtpTemplateRenewalPdfSigningProofPhase61Markdown(report), 'utf8')
