...
assert.match(migration, /revoke all on function public\.bridge_seed_mvp_transaction_participants\(uuid, jsonb\) from public, anon, authenticated/)
assert.match(migration, /revoke all on function public\.bridge_seed_mvp_transaction_documents\(uuid, jsonb\) from public, anon, authenticated/)
assert.match(migration, /revoke all on function public\.bridge_seed_mvp_transaction_workflow_lanes\(uuid, uuid, jsonb\) from public, anon, authenticated/)
