...
const checkedAt = process.env.OTP_FINAL_PRODUCTION_READINESS_GATE_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpFinalProductionReadinessGatePhase29Audit({
  checkedAt,
  phase27Audit,
  phase28Audit,
})
const outputUrl = new URL('../docs/otp-final-production-readiness-gate-phase29.md', import.meta.url)

await writeFile(outputUrl, formatOtpFinalProductionReadinessGatePhase29Markdown(report), 'utf8')
