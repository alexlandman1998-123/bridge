...
assert.match(attorneyService, /commitSharedJourneyTask/)
assert.match(attorneyService, /commitSharedJourneyLaneUpdate/)
assert.match(attorneyService, /TRANSFER_ATTORNEY_UPDATE_PUBLISHED/)
assert.match(attorneyService, /BOND_ATTORNEY_UPDATE_PUBLISHED/)
assert.match(attorneyService, /CANCELLATION_ATTORNEY_UPDATE_PUBLISHED/)
