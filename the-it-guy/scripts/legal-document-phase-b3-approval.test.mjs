...
const phase4Migration = fs.readFileSync('../supabase/migrations/202607220007_phase4_legal_runtime_metadata_immutability.sql', 'utf8')
const phase4Integrity = fs.readFileSync('../supabase/migrations/202607220008_phase4_legal_template_release_integrity.sql', 'utf8')
...
assert.match(phase4Migration, /legal_phase4_b3_release_contract/)
assert.match(phase4Migration, /phase4-b3-integrity-v1/)
assert.match(phase4Migration, /coalesce\(auth\.role\(\), ''\) <> 'service_role'/)
assert.match(phase4Integrity, /Legal release audit events are service-owned/)
...
assert.match(verify, /legal_phase4_b3_release_contract/)
assert.match(verify, /phase4-b3-integrity-v1/)
assert.match(verify, /payload\.phase4B3ReleaseContract/)
assert.match(verify, /row\.actor_role === 'service_role'/)
assert.match(verify, /document_packet_template_release_provenance_phase4/)
assert.match(verify, /provenance\.audit_event_id === row\.id/)
