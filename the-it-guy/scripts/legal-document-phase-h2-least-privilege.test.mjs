...
for (const file of ['../supabase/functions/generate-final-signed-document/index.ts', '../supabase/functions/generate-final-signed-otp/index.ts']) assert.match(fs.readFileSync(file, 'utf8'), /FINALISER_CONTRACT = "h[234]-v1"/)
