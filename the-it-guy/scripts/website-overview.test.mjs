...
assert.ok(component.includes('Choose a featured image from the media library') && component.includes('Remove featured image'), 'Blog management should let authors visually choose or clear a featured image.')
assert.ok(component.includes('Save image description') && component.includes('wherever this image is used'), 'Blog management should make shared media-description updates explicit.')
