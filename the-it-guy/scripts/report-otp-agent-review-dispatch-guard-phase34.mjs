...
const checkedAt = process.env.OTP_AGENT_REVIEW_DISPATCH_GUARD_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpAgentReviewDispatchGuardPhase34Audit({
  checkedAt,
  phase33Audit,
  packetServiceSource,
  workspaceSource,
...
const outputUrl = new URL('../docs/otp-agent-review-dispatch-guard-phase34.md', import.meta.url)

await writeFile(outputUrl, formatOtpAgentReviewDispatchGuardPhase34Markdown(report), 'utf8')
