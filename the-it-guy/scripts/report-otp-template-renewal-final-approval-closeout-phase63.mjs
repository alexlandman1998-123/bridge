...
const checkedAt = process.env.OTP_TEMPLATE_RENEWAL_FINAL_CLOSEOUT_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpTemplateRenewalFinalApprovalCloseoutPhase63Audit({
  checkedAt,
  phase62Audit,
  packageJson,
})
const outputUrl = new URL('../docs/otp-template-renewal-final-approval-closeout-phase63.md', import.meta.url)

await writeFile(outputUrl, formatOtpTemplateRenewalFinalApprovalCloseoutPhase63Markdown(report), 'utf8')
