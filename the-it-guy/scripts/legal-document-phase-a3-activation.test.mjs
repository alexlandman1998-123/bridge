...
assert.match(smoke, /generate-mandate/)
assert.match(smoke, /LEGAL_TEMPLATE_APPROVAL_REQUIRED/)
assert.match(smoke, /LEGAL_TEMPLATE_RUNTIME_APPROVAL_REQUIRED/)
assert.match(smoke, /LEGAL_TEMPLATE_SOURCE_MISMATCH/)
assert.match(smoke, /LEGAL_DOCUMENT_PHASE4_AUDIT_SMOKE_APPROVED/)
assert.doesNotMatch(smoke, /generate-otp/)
