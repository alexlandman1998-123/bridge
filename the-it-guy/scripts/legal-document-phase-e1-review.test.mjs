...
assert.match(api, /assertDraftReviewApproval\(\{ packet, version: targetVersion \}\)/)
assert.match(workspace, /buildDraftReviewApprovalSnapshot/)
assert.match(workspace, /approvedByUserId/)
...
console.log('Legal document E1 accountable draft-review contract passed.')
