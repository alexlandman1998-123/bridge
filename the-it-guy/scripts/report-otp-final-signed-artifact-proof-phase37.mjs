...
const checkedAt = process.env.OTP_FINAL_SIGNED_ARTIFACT_PROOF_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpFinalSignedArtifactProofPhase37Audit({
  checkedAt,
  phase36Audit,
  packetServiceSource,
  packageJson,
})
const outputUrl = new URL('../docs/otp-final-signed-artifact-proof-phase37.md', import.meta.url)

await writeFile(outputUrl, formatOtpFinalSignedArtifactProofPhase37Markdown(report), 'utf8')
