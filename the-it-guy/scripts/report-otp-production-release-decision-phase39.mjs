...
const checkedAt = process.env.OTP_PRODUCTION_RELEASE_DECISION_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpProductionReleaseDecisionPhase39Audit({
  checkedAt,
  phase38Audit,
  packageJson,
})
const outputUrl = new URL('../docs/otp-production-release-decision-phase39.md', import.meta.url)

await writeFile(outputUrl, formatOtpProductionReleaseDecisionPhase39Markdown(report), 'utf8')
