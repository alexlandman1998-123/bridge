...
const checkedAt = process.env.OTP_POST_CUTOVER_MONITORING_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpPostCutoverMonitoringPhase41Audit({
  checkedAt,
  phase40Audit,
  packageJson,
})
const outputUrl = new URL('../docs/otp-post-cutover-monitoring-phase41.md', import.meta.url)

await writeFile(outputUrl, formatOtpPostCutoverMonitoringPhase41Markdown(report), 'utf8')
