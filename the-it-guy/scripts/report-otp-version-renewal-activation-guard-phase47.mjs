...
const checkedAt = process.env.OTP_VERSION_RENEWAL_ACTIVATION_GUARD_REPORT_TIME || new Date().toISOString()
...
const report = buildOtpVersionRenewalActivationGuardPhase47Audit({
  checkedAt,
  phase46Audit,
  packageJson,
})
const outputUrl = new URL('../docs/otp-version-renewal-activation-guard-phase47.md', import.meta.url)

await writeFile(outputUrl, formatOtpVersionRenewalActivationGuardPhase47Markdown(report), 'utf8')
