...
assert.equal(permanent.bondOriginatorContainerSummary.total, 1)
assert.equal(permanent.bondOriginatorContainerSummary.blocking, 1)
...
assert.equal(report.gate.status, 'bond_model_mapped_with_warnings')
