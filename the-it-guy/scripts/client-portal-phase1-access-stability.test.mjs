...
assert.doesNotMatch(privateListingService, /sessionExpired: Boolean\(rpc\.data\?\.sessionExpired \|\| accessToken\)/, 'a present access token must not turn an ambiguous response into an expiry')
