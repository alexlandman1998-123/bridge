...
assertIncludes(telemetry, "'retrying'", 'Auth bridge retrying outcome')
assertIncludes(telemetry, "'degraded'", 'Auth bridge degraded outcome')
assertIncludes(telemetry, "'bootHealthStatus'", 'Auth bridge boot-health text metadata')
assertIncludes(telemetry, "'retryReason'", 'Auth bridge retry reason metadata')
assertIncludes(telemetry, "'breadcrumbCount'", 'Auth bridge breadcrumb count metadata')
