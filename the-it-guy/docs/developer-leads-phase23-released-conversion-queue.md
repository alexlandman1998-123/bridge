# Developer Leads Phase 23 Released Conversion Queue

Phase 23 closes the gap after agency handover release.

## What It Adds

- Adds a developer-side released buyer conversion panel.
- Lists agency-fed leads where `visibility_state = handed_over`.
- Keeps protected and consent-pending leads out of the conversion queue.
...
keeps buyer onboarding send on the existing conversion path.
...
conversion to the established Phase 18 service.
