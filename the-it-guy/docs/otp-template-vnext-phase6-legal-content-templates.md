...
| Check | Pass | Detail |
| --- | --- | --- |
| PHASE6_BRANDED_SHELL_READY | yes | Legal content templates depend on the Phase 5 branded shell being ready. |
...
| 60 | development_compliance_body_corporate | new_development | body_corporate | yes | body_corporate_name, body_corporate_rules_annexure, development_levy_estimate, development_rates_estimate, utility_connection_charges, compliance_certificate_schedule |
...
| 70 | transfer_conveyancer | resale_existing_property, new_development | transfer_conveyancer | yes | transfer_attorney_company_name, trust_account_recipient, guarantee_delivery_deadline, guarantee_delivery_period |
