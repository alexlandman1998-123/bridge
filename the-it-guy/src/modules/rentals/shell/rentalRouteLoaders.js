...
export const RentalTenancyWorkspacePage = lazy(() => import('../../../pages/rentals/RentalTenancyWorkspacePage'))
...
export const RentalTenantPortalActionsPage = lazy(() => import('../../../pages/rentals/RentalTenantPortalActionsPage'))
export const RentalLandlordPortalDecisionsPage = lazy(() => import('../../../pages/rentals/RentalLandlordPortalDecisionsPage'))
export const RentalLandlordPortalPage = lazy(() => import('../../../pages/rentals/RentalLandlordPortalPage'))
export const RentalRenewalWorkspacePage = lazy(() => import('../../../pages/rentals/RentalRenewalWorkspacePage'))
export const RentalNoticeWorkspacePage = lazy(() => import('../../../pages/rentals/RentalNoticeWorkspacePage'))
