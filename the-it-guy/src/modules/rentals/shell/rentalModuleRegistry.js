...
export const RENTAL_MODULE_ROUTE_IDS = Object.freeze({
  ...
  calendar: 'calendar', collections: 'collections', listingCreate: 'listing_create', listingDetail: 'listing_detail', listings: 'listings',
})
...
const routes = Object.freeze({
  ...
  [RENTAL_MODULE_ROUTE_IDS.collections]: '/agent/rentals/collections',
