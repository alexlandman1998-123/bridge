export const REQUIREMENT_LIFECYCLE = [
  ...
  { value: 'hot', label: 'Heads of Terms', tone: 'violet' },
...
export const VACANCY_LIFECYCLE = [
  ...
  { value: 'hot_in_progress', label: 'Heads of Terms In Progress', tone: 'violet' },
...
export const DEAL_LIFECYCLE = [
  ...
  { value: 'hot_draft', label: 'Heads of Terms Draft', tone: 'slate' },
  { value: 'hot_sent', label: 'Heads of Terms Sent', tone: 'blue' },
  { value: 'hot_accepted', label: 'Heads of Terms Accepted', tone: 'emerald' },
...
export const TRANSACTION_LIFECYCLE = [
  ...
  { value: 'hot_in_progress', label: 'Heads of Terms In Progress', tone: 'violet' },
  { value: 'hot_signed', label: 'Heads of Terms Signed', tone: 'emerald' },
  { value: 'lease_pending', label: 'Lease Pending', tone: 'amber' },
