...
export const COMMERCIAL_DOCUMENT_CATEGORIES = {
  commercial_landlord: [
    ...
    { value: 'letters_of_authority', label: 'Letters of Authority' },
    { value: 'trustee_id_documents', label: 'Trustee ID Documents' },
    { value: 'entity_authorisation_document', label: 'Entity Authorisation Document' },
    { value: 'official_contact_details', label: 'Official Contact Details' },
    ...
    { value: 'property_schedule', label: 'Property Schedule' },
    { value: 'existing_lease_schedule', label: 'Existing Lease Schedule' },
    { value: 'company_profile', label: 'Company Profile' },
    { value: 'rates_accounts', label: 'Rates Accounts' },
    { value: 'mandate_document', label: 'Mandate Document' },
