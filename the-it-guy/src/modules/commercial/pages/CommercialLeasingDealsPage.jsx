...
import CommercialLeasingDealCreateModal from '../components/CommercialLeasingDealCreateModal'
...
const LEASING_DEALS_CONFIG = {
  ...
  createLabel: 'Create Leasing Deal',
  createModal: CommercialLeasingDealCreateModal,
