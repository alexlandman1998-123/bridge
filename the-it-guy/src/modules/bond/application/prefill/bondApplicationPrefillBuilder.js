...
const SPECIAL_CONTEXT_PATHS = new Map([
  ...
  ['formData.spouse_full_name.first', ({ formData }) => splitName(formData?.spouse_full_name).firstName],
  ['formData.spouse_full_name.last', ({ formData }) => splitName(formData?.spouse_full_name).lastName],
