...
export default function useAttorneyPermissions({ firmId = null } = {}) {
  ...
  return {
    ...
    canNominateAttorneyFirms: hasPermission('can_nominate_attorney_firms'),
    canManageAttorneyAssignments: hasPermission('can_manage_attorney_assignments'),
    canActOnBehalfOfAttorney: hasPermission('can_act_on_behalf_of_attorney'),
