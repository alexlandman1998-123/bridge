...
function DevelopmentBondCommercialSetup({ developmentId, previewRows = [], onSaved }) {
        ...
        <div className="flex flex-col gap-4">
          ...
          {usingPreviewRows ? (
            <p className="rounded-[16px] border border-[#dde4ee] bg-[#f8fafc] px-4 py-3 text-sm text-[#6b7d93]">
              Showing projected bond commission rows until statement values and close-out records are captured for this originator.
            </p>
          ) : null}
