  ...
  return (
    <div className={`flex flex-col gap-4 md:flex-row md:items-end md:justify-between ${className}`.trim()}>
      <div className="min-w-0">
        <h1 className="text-[2rem] font-semibold tracking-[-0.045em] text-[#142132]">{title}</h1>
        {subtitle ? <p className="mt-2 max-w-3xl text-[1.02rem] leading-7 text-[#6b7d93]">{subtitle}</p> : null}
      </div>
