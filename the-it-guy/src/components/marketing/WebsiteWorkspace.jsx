...
export default function WebsiteWorkspace({ onBack }) {
  ...
  if (!showStudio) return (
    <div className="wa-page website-workspace website-overview">
      ...
      <nav className="wlo-tabs" aria-label="Website sections"><a className="active" href="#website-overview">Overview</a><a href="/clients?source=website">Leads</a><a href="#website-performance">Analytics</a><a href="#website-activity">Form submissions</a><button type="button" onClick={() => setShowStudio(true)}>Blog</button><button type="button" onClick={() => setShowStudio(true)}>Studio</button></nav>
      ...
      <section className="wlo-lower"><div id="website-performance"><WebsitePerformance analytics={overview.analytics} /></div><div id="website-activity"><WebsiteActivity publicationEvents={overview.publicationEvents} managementEvents={overview.managementEvents} /></div></section>
