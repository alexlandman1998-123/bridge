...
const PAGE_ORDER = { home: 0, about: 1, contact: 2, valuation: 3, campaign: 4, blog: 5 }
const PAGE_LABELS = { home: 'Home', about: 'About', contact: 'Contact', valuation: 'Valuation', campaign: 'Campaign', blog: 'Blog article' }
...
export default function WebsitePageEditor({ pages, revisionId, busy, onSave, onDeleteCampaign }) {
  ...
  const customUrl = campaign || draft.page_kind === 'blog'
