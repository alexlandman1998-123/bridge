export default function LeadsRouteShell({ label = '', loadStage = '' }) {
  return (
    <section className="min-w-0 space-y-5" aria-busy="true" aria-label={label || 'Loading leads'} data-lead-workspace-load-stage={loadStage || undefined}>
