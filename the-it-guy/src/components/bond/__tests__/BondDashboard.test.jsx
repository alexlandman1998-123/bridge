...
;(async () => {
  ...
  try {
    ...
    assert.doesNotMatch(hqMarkup, /Bond Performance/)
    assert.doesNotMatch(hqMarkup, />Overview</)
    assert.doesNotMatch(hqMarkup, />Operations</)
    assert.doesNotMatch(hqMarkup, />Performance</)
    ...
    assert.match(hqMarkup, /Applications Pipeline/)
    ...
    assert.doesNotMatch(hqMarkup, /Median Time to Register/)
    assert.match(hqMarkup, /Active Applications/)
    assert.match(hqMarkup, /The current bond files your team is actively moving/)
    ...
    assert.doesNotMatch(hqMarkup, /Bank Performance/)
    assert.doesNotMatch(hqMarkup, /Lindiwe M\./)
    assert.doesNotMatch(hqMarkup, /Property Hub/)
    assert.doesNotMatch(hqMarkup, /Standard Bank/)
