...
export const SIGNUP_POSITION_INTENT_MAP = Object.freeze({
  ...
  attorney_owner: {
    app_role: SIGNUP_ROLE_CONTRACTS.attorney_owner.profileRole,
    system_role: SIGNUP_ROLE_CONTRACTS.attorney_owner.systemRole,
    workspace_type: SIGNUP_ROLE_CONTRACTS.attorney_owner.workspaceType,
    workspace_kind: SIGNUP_ROLE_CONTRACTS.attorney_owner.defaultWorkspaceKind,
    intended_org_role: SIGNUP_ROLE_CONTRACTS.attorney_owner.intendedOrgRole,
    role_contract_key: SIGNUP_ROLE_CONTRACTS.attorney_owner.key,
    authority_level: SIGNUP_AUTHORITY_LEVELS.ownerManagement,
    onboarding_path: SIGNUP_ONBOARDING_PATHS.attorneyOwner,
    workspace_action: SIGNUP_WORKSPACE_ACTIONS.createWorkspace,
  },
  attorney_operational: {
    app_role: SIGNUP_ROLE_CONTRACTS.attorney_operational.profileRole,
    system_role: SIGNUP_ROLE_CONTRACTS.attorney_operational.systemRole,
    workspace_type: SIGNUP_ROLE_CONTRACTS.attorney_operational.workspaceType,
    workspace_kind: SIGNUP_ROLE_CONTRACTS.attorney_operational.defaultWorkspaceKind,
    intended_org_role: SIGNUP_ROLE_CONTRACTS.attorney_operational.intendedOrgRole,
    role_contract_key: SIGNUP_ROLE_CONTRACTS.attorney_operational.key,
    authority_level: SIGNUP_AUTHORITY_LEVELS.operational,
