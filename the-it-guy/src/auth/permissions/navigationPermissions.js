...
export const navPermissionByKey = Object.freeze({
  ...
  developer_leads: PERMISSIONS.viewSalesPipeline,
  ...
  rental_dashboard: PERMISSIONS.viewAgencyDashboard,
  rental_tenancies: PERMISSIONS.viewTransactions,
  rental_pipeline: PERMISSIONS.viewLeads,
  rental_pipeline_leads: PERMISSIONS.viewLeads,
  rental_pipeline_applications: PERMISSIONS.viewLeads,
  rental_pipeline_calendar: PERMISSIONS.manageAppointments,
  rental_listings: PERMISSIONS.viewListings,
  rental_agency: PERMISSIONS.manageBranches,
  rental_agency_branches: PERMISSIONS.manageBranches,
  rental_agency_people: PERMISSIONS.manageUsers,
  rental_agency_partners: PERMISSIONS.partnersViewNetwork,
  rental_agency_commission: PERMISSIONS.viewCommissionStructures,
  rental_clients: PERMISSIONS.viewClients,
  rental_reports: PERMISSIONS.viewReports,
  ...
  agency_commission: PERMISSIONS.viewCommissionStructures,
  agency_analytics: PERMISSIONS.viewReports,
  developer_agencies: PERMISSIONS.viewDevelopments,
