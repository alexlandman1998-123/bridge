...
export const permissionsByWorkspaceRole = Object.freeze({
  ...
  [WORKSPACE_TYPES.attorneyFirm]: Object.freeze({
    ...
    [ORG_ROLES.adminStaff]: grant(ACCESS_SCOPES.departmentOnly, [PERMISSIONS.viewDashboard, PERMISSIONS.viewAttorneyDashboard, PERMISSIONS.viewMatters, PERMISSIONS.manageSigningAppointments, PERMISSIONS.viewClients, PERMISSIONS.viewTransactions]),
  ...
  [WORKSPACE_TYPES.bondOriginator]: Object.freeze({
    ...
    [ORG_ROLES.processor]: grant(ACCESS_SCOPES.teamOnly, [PERMISSIONS.viewDashboard, PERMISSIONS.viewBondDashboard, PERMISSIONS.viewApplications, PERMISSIONS.editApplications, PERMISSIONS.updateBondStatus, PERMISSIONS.manageBankFeedback, PERMISSIONS.requestFinanceDocs, PERMISSIONS.viewClients, PERMISSIONS.viewTransactions]),
    [ORG_ROLES.adminStaff]: grant(ACCESS_SCOPES.teamOnly, [PERMISSIONS.viewDashboard, PERMISSIONS.viewBondDashboard, PERMISSIONS.viewApplications, PERMISSIONS.requestFinanceDocs, PERMISSIONS.viewClients, PERMISSIONS.viewTransactions]),
