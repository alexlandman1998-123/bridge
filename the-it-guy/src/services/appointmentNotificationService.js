...
async function sendAppointmentEmailToRecipient({ recipientEmail, eventType, appointment, participant = {}, metadata = {} }) {
  ...
  const body = {
    ...
    organisationLogoUrl: normalizeText(metadata?.organisationLogoUrl || metadata?.logoUrl || ''),
    organisationLogoLightUrl: normalizeText(metadata?.organisationLogoLightUrl || metadata?.logoLightUrl || ''),
    organisationLogoDarkUrl: normalizeText(metadata?.organisationLogoDarkUrl || metadata?.logoDarkUrl || ''),
    organisationLogoIconUrl: normalizeText(metadata?.organisationLogoIconUrl || metadata?.logoIconUrl || ''),
    organisationBrandPrimaryColor: normalizeText(metadata?.organisationBrandPrimaryColor || metadata?.primaryColor || metadata?.primaryColour || ''),
    organisationBrandSecondaryColor: normalizeText(metadata?.organisationBrandSecondaryColor || metadata?.secondaryColor || metadata?.secondaryColour || ''),
    supportEmail: normalizeText(metadata?.supportEmail || ''),
