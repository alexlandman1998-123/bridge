...
const ACTION_ADAPTERS = {
  ...
  TRANSFER_ATTORNEY_UPDATE_PUBLISHED: ['transfer_attorney', 'transaction_attorney_lane_updates', 'client_visible', ['buyer', 'seller', ...PROFESSIONAL_AUDIENCE]],
  ...
  BOND_ATTORNEY_UPDATE_PUBLISHED: ['bond_attorney', 'transaction_attorney_lane_updates', 'client_visible', ['buyer', 'seller', ...PROFESSIONAL_AUDIENCE]],
  ...
  CANCELLATION_ATTORNEY_UPDATE_PUBLISHED: ['cancellation_attorney', 'transaction_attorney_lane_updates', 'client_visible', ['seller', 'agent', 'bond_originator', 'transfer_attorney', 'bond_attorney', 'cancellation_attorney']],
