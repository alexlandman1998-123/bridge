...
const SELECT_FIELDS = 'id, organisation_id, property_id, branch_id, unit_label, bedrooms, bathrooms, status, rental_properties!inner(id, name, metadata_json), rental_unit_operating_modes(id, operating_mode, status, effective_from, effective_to, configuration), rental_unit_occupancy_blocks(id, status, starts_at, ends_at, source_type)'
