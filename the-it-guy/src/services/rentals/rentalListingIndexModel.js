...
export function buildRentalListingIndexRow(listing = {}) {
  ...
  const address = firstText(
    // `propertyAddress` is a presentation fallback from some listing readers
    // and may include address line 2. Prefer the canonical first address line
    // so a guided edit cannot re-save a concatenated address as line 1.
  ...
  const row = {
    ...
    rentalPriceFrequency: firstText(rentalInfo.rentalPriceFrequency, rentalInfo.rental_price_frequency, listing.rentalPriceFrequency, listing.rental_price_frequency, publication.rentalTerms?.rentalPriceFrequency, publication.rentalTerms?.rental_price_frequency),
    ...
    depositPolicy: firstText(rentalInfo.depositPolicy, rentalInfo.deposit_policy, listing.depositPolicy, listing.deposit_policy, publication.rentalTerms?.depositPolicy, publication.rentalTerms?.deposit_policy),
    ...
    rentalMandateType: firstText(rentalInfo.rentalMandateType, rentalInfo.rental_mandate_type, listing.rentalMandateType, listing.rental_mandate_type, publication.rentalTerms?.rentalMandateType, publication.rentalTerms?.rental_mandate_type),
    ...
    retirementAccommodation: firstText(propertyProfile.retirementAccommodation, propertyProfile.retirement_accommodation, publication.retirementAccommodation, publication.retirement_accommodation, listing.retirementAccommodation, listing.retirement_accommodation),
