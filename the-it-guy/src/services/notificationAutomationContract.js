...
export const NOTIFICATION_AUTOMATION_KEYS = Object.freeze({
  ...
  SELLER_MANDATE_VIEWED_UNSIGNED_REMINDER: 'seller_mandate_viewed_unsigned_reminder',
  SELLER_MANDATE_SIGNING_OVERDUE_ESCALATION: 'seller_mandate_signing_overdue_escalation',
  BUYER_ONBOARDING_OPENED: 'buyer_onboarding_opened',
  BUYER_ONBOARDING_STARTED_NOT_SUBMITTED_REMINDER: 'buyer_onboarding_started_not_submitted_reminder',
  BUYER_ONBOARDING_OVERDUE_ESCALATION: 'buyer_onboarding_overdue_escalation',
  BUYER_ONBOARDING_SUBMITTED_CONFIRMATION: 'buyer_onboarding_submitted_confirmation',
  ...
  ATTORNEY_CLIENT_FINANCIAL_DOCUMENT_PUBLISHED: 'attorney_client_financial_document_published',
  ...
  BOND_ORIGINATOR_WEEKLY_PIPELINE_DIGEST: 'bond_originator_weekly_pipeline_digest',
  ...
  COMMERCIAL_CANVASSING_PROSPECT_CREATED: 'commercial_canvassing_prospect_created',
  ...
  COMMERCIAL_HEADS_OF_TERMS_STATUS_CHANGED: 'commercial_heads_of_terms_status_changed',
  COMMERCIAL_TRANSACTION_STATUS_CHANGED: 'commercial_transaction_status_changed',
  ENTERPRISE_MEMBER_SCOPE_CHANGED: 'enterprise_member_scope_changed',
  ENTERPRISE_BRANCH_TEAM_ASSIGNMENT_CHANGED: 'enterprise_branch_team_assignment_changed',
})
...
export const NOTIFICATION_AUTOMATION_DEFINITIONS = Object.freeze([
  ...
  definition({
    ...
    reminderPolicy: {
      ...
      escalation: {
        ...
        label: 'Escalate stalled transactions when no meaningful activity is recorded.',
      },
    },
  }),
  definition({
  ...
  definition({
    key: NOTIFICATION_AUTOMATION_KEYS.SELLER_MANDATE_SIGNING_OVERDUE_ESCALATION,
  ...
  definition({
    key: NOTIFICATION_AUTOMATION_KEYS.BUYER_ONBOARDING_STARTED_NOT_SUBMITTED_REMINDER,
    ...
    reminderPolicy: {
      ...
      escalation: {
        ...
        afterDay: 2,
        recipientRole: 'agent',
        label: 'Escalate buyer onboarding that was started but not submitted.',
      },
    },
  }),
  definition({
  ...
  definition({
    key: NOTIFICATION_AUTOMATION_KEYS.ATTORNEY_CLIENT_FINANCIAL_DOCUMENT_PUBLISHED,
  ...
  definition({
    key: NOTIFICATION_AUTOMATION_KEYS.COMMERCIAL_HEADS_OF_TERMS_STATUS_CHANGED,
  ...
  definition({
    key: NOTIFICATION_AUTOMATION_KEYS.ENTERPRISE_BRANCH_TEAM_ASSIGNMENT_CHANGED,
...
export function resolveNotificationAutomationKey({
  ...
  if (['client_onboarding', 'buyer_verification_link', 'buyer_offer_link'].includes(normalizedCommunicationType)) {
