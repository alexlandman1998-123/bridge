...
export const DEFAULT_STAGE_GATE_MAPPING = Object.freeze({
  ...
  instruction_received: 'attorney_instruction_ready',
  matter_opened: 'attorney_instruction_ready',
  otp_source_docs_checked: 'attorney_instruction_ready',
  buyer_fica_review: 'attorney_instruction_ready',
  seller_fica_review: 'attorney_instruction_ready',
  transfer_duty_vat_review: 'attorney_instruction_ready',
  transfer_tax_route_confirmed: 'attorney_instruction_ready',
  transfer_duty_tdc01_submission: 'lodgement_ready',
  sars_evidence_request_response: 'lodgement_ready',
  transfer_duty_assessment_payment: 'lodgement_ready',
  vat_exemption_evidence_verified: 'lodgement_ready',
  non_resident_seller_withholding_review: 'lodgement_ready',
  ordinary_vat_basis_verified: 'lodgement_ready',
  going_concern_zero_rate_verified: 'lodgement_ready',
  transfer_duty_exemption_basis_verified: 'lodgement_ready',
  non_resident_seller_applicability_review: 'lodgement_ready',
  non_resident_seller_directive_review: 'lodgement_ready',
  non_resident_seller_withholding_payment_review: 'lodgement_ready',
  sars_transfer_tax_receipt_verified: 'lodgement_ready',
  municipal_rates_clearance_review: 'attorney_instruction_ready',
  levy_hoa_clearance_review: 'attorney_instruction_ready',
  body_corporate_levy_clearance_review: 'attorney_instruction_ready',
  hoa_clearance_review: 'attorney_instruction_ready',
  property_conditions_applicability_review: 'attorney_instruction_ready',
  title_conditions_review: 'attorney_instruction_ready',
  property_compliance_review: 'attorney_instruction_ready',
  transfer_document_pack_review: 'lodgement_ready',
  buyer_signing_review: 'lodgement_ready',
  seller_signing_review: 'lodgement_ready',
  payment_security_review: 'lodgement_ready',
  buyer_fica_requested: 'attorney_instruction_ready',
  buyer_fica_received: 'attorney_instruction_ready',
  buyer_fica_approved: 'attorney_instruction_ready',
  seller_fica_requested: 'attorney_instruction_ready',
  seller_fica_received: 'attorney_instruction_ready',
  seller_fica_approved: 'attorney_instruction_ready',
  entity_authority_checked: 'attorney_instruction_ready',
  title_deed_checked: 'attorney_instruction_ready',
  existing_bond_confirmed: 'attorney_instruction_ready',
  finance: 'finance_ready',
  bond: 'finance_ready',
  bond_approval: 'finance_ready',
  finance_ready: 'finance_ready',
  bond_instruction_received: 'finance_ready',
  bank_reference_captured: 'finance_ready',
  bond_approval_letter_received: 'finance_ready',
  bank_requirements_confirmed: 'finance_ready',
  bank_conditions_reviewed: 'finance_ready',
  bank_conditions_outstanding: 'finance_ready',
  bank_conditions_resolved: 'finance_ready',
  bond_documents_prepared: 'finance_ready',
  buyer_bond_signing_scheduled: 'finance_ready',
  buyer_signed_bond_documents: 'finance_ready',
  bond_documents_sent_to_bank: 'finance_ready',
  bank_approval_to_lodge_received: 'lodgement_ready',
  guarantees_issued: 'finance_ready',
  grant_signed: 'finance_ready',
  guarantee_wording_accepted: 'lodgement_ready',
  transfer_duty_assessment_prepared: 'lodgement_ready',
  transfer_duty_submitted: 'lodgement_ready',
  transfer_duty_receipt_received: 'lodgement_ready',
  rates_figures_requested: 'lodgement_ready',
  rates_payment_confirmed: 'lodgement_ready',
  rates_clearance_received: 'lodgement_ready',
  levy_clearance_requested: 'lodgement_ready',
  levy_clearance_received: 'lodgement_ready',
  compliance_certificates_received: 'lodgement_ready',
  transfer_documents_prepared: 'lodgement_ready',
  buyer_signing_scheduled: 'lodgement_ready',
  buyer_signed_transfer_documents: 'lodgement_ready',
  seller_signing_scheduled: 'lodgement_ready',
  seller_signed_transfer_documents: 'lodgement_ready',
  guarantees_requested: 'lodgement_ready',
  guarantees_received: 'lodgement_ready',
  transfer_guarantees_accepted: 'lodgement_ready',
  guarantees_accepted: 'lodgement_ready',
  lodgement: 'lodgement_ready',
  lodged: 'lodgement_ready',
  lodgement_submitted: 'lodgement_ready',
  lodged_at_deeds_office: 'lodgement_ready',
  pre_lodgement: 'lodgement_ready',
  lodgement_ready: 'lodgement_ready',
  lodgement_pack_prepared: 'lodgement_ready',
  lodgement_pack_checked: 'lodgement_ready',
  bond_lodgement_ready: 'lodgement_ready',
  bond_lodgement_pack_prepared: 'lodgement_ready',
  bond_lodged: 'lodgement_ready',
  bond_lodgement_submitted: 'lodgement_ready',
  cancellation_existing_bond_confirmed: 'attorney_instruction_ready',
  cancellation_bank_captured: 'attorney_instruction_ready',
  cancellation_bond_account_captured: 'attorney_instruction_ready',
  cancellation_instruction_received: 'attorney_instruction_ready',
  notice_period_captured: 'attorney_instruction_ready',
  cancellation_figures_requested: 'lodgement_ready',
  cancellation_figures_received: 'lodgement_ready',
  figures_expiry_captured: 'lodgement_ready',
  notice_penalty_risk_captured: 'lodgement_ready',
  cancellation_guarantees_requested: 'lodgement_ready',
  cancellation_guarantees_received: 'lodgement_ready',
  cancellation_guarantees_accepted: 'lodgement_ready',
  cancellation_documents_prepared: 'lodgement_ready',
  seller_cancellation_documents_signed: 'lodgement_ready',
  cancellation_lodgement_ready: 'lodgement_ready',
  cancellation_lodged: 'lodgement_ready',
  in_prep: 'registration_ready',
  prep: 'registration_ready',
  ...
  bond_registration_confirmed: 'registration_ready',
  bond_close_out_complete: 'registration_ready',
  cancellation_registered: 'registration_ready',
  settlement_proof_captured: 'registration_ready',
  cancellation_close_out_complete: 'registration_ready',
  final_accounts_prepared: 'registration_ready',
  registration_letter_issued: 'registration_ready',
  post_registration_closeout_review: 'registration_ready',
  matter_closed: 'registration_ready',
