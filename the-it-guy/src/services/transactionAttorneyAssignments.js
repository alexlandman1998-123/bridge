...
function mapAssignmentRow(row) {
  ...
  return {
    ...
    status: [row.assignment_status, row.status].includes('removed') ? 'removed' : row.assignment_status || row.status,
    assignmentStatus: [row.assignment_status, row.status].includes('removed') ? 'removed' : row.assignment_status || row.status,
    isPrimary,
