...
const BUYER_PROCESS_STAGES = Object.freeze([
  ...
  Object.freeze({
    ...
    label: 'Signed OTP received',
    phase: 'offer',
    description: 'A signed OTP has been uploaded and is ready for transaction conversion.',
...
const BUYER_PROCESS_EVIDENCE_GATES = Object.freeze([
  ...
  Object.freeze({
    ...
    communicationTypes: Object.freeze(['client_onboarding', 'buyer_verification_link', 'buyer_offer_link']),
    recipientRole: 'buyer',
...
const BUYER_STAGE_ALIASES = Object.freeze({
  ...
  buyer_verification_sent: BUYER_PROCESS_STAGE_KEYS.buyerOnboardingSent,
  buyer_verification_link_sent: BUYER_PROCESS_STAGE_KEYS.buyerOnboardingSent,
  verification_link_sent: BUYER_PROCESS_STAGE_KEYS.buyerOnboardingSent,
  ...
  signed_otp_received: BUYER_PROCESS_STAGE_KEYS.offerReceived,
