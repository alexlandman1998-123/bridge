...
export const BUYER_OTP_DEPRECATION_NOTICE = 'OTP generation is deprecated for buyer leads. Capture buyer onboarding first, then upload the signed OTP and move the buyer through OTP Transaction.'
