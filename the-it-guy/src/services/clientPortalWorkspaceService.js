...
function mapLaneStepToClientText(laneKey = '', step = null, fallback = '') {
  ...
  const byLane = {
    ...
    transfer: {
      ...
      buyer_fica_review: 'Buyer verification documents are being reviewed.',
      ...
      seller_signing_review: 'Seller signing is being managed and reviewed.',
      payment_security_review: 'The applicable payment security is being reviewed.',
      ...
      post_registration_closeout_review: 'Final accounts and registration close-out are being completed.',
...
export async function getClientPortalWorkspaceData(token, workspace = 'shared', options = {}) {
  ...
  return {
    ...
    transactionSync: workflowReadModel?.transactionSync || null,
