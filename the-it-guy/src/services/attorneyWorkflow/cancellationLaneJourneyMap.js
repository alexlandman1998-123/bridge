...
export const CANCELLATION_LANE_HANDOFFS = Object.freeze([
  ...
  Object.freeze({
    ...
    toStageKey: 'payment_security_review',
  ...
  Object.freeze({
    ...
    fromOwnerRole: 'cancellation_attorney',
    toOwnerRole: 'transfer_attorney',
    fromStageKeys: ['cancellation_simultaneous_lodgement_confirmed', 'cancellation_lodgement_ready', 'cancellation_lodged'],
...
export const CANCELLATION_PHASE4_GUARANTEE_COORDINATION_PAIRS = Object.freeze([
  Object.freeze({
    ...
    requestingStageKey: 'payment_security_review',
  ...
  Object.freeze({
    ...
    dependencyStageKey: 'payment_security_review',
...
export function buildCancellationLaneJourneyMap() {
  ...
  return {
    ...
    rolloutBaseline: {
      ...
      guaranteeDependency: 'payment_security_review',
