...
export const PERFORMANCE_BUDGETS_MS = Object.freeze({
  ...
  'agent_clients.route.shell_ready': 1500,
  'agent_clients.route.core_ready': 2500,
  'agent_clients.route.settled': 5000,
  'agent_listings.route.shell_ready': 1500,
  'agent_listings.route.core_ready': 2500,
  'agent_listings.route.settled': 5000,
  'agent_canvassing.route.shell_ready': 1500,
  'agent_canvassing.route.core_ready': 2500,
  'agent_canvassing.route.settled': 5000,
  'agent_calendar.route.shell_ready': 1500,
  'agent_calendar.route.core_ready': 2500,
  'agent_calendar.route.settled': 5000,
  ...
  'attorney_matters.list_ready': 4000,
  'attorney_matters.access_check': 1500,
  'attorney_matters.detail_core_ready': 3000,
  'attorney_matters.dataset_ready': 2000,
})
