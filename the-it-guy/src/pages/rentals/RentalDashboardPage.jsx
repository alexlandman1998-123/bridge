...
export default function RentalDashboardPage() {
  ...
  const cards = [
    ['Active listings', snapshot?.activeListings, Building2, '/agent/rentals/listings'], ['Tenant leads', snapshot?.tenantLeads, Users, '/agent/rentals/pipeline/leads'], ['Open applications', snapshot?.openApplications, ClipboardList, '/agent/rentals/pipeline/applications'], ['Active tenancies', snapshot?.activeTenancies, FileSignature, '/agent/rentals/tenancies'],
  ]
