...
export const SETTINGS_NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        to: '/settings/property24',
        label: 'Property24',
        description: 'Agency account setup, agent sync, and portal publishing mappings.',
        icon: PlugZap,
        roles: ['agent'],
        permission: PERMISSIONS.manageWorkspaceSettings,
        keywords: 'property24 syndication portal publishing agency id agent id source reference listings integration exdev production',
      },
    ],
  },
]
