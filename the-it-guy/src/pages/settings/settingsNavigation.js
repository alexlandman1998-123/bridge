...
export const SETTINGS_NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        to: '/settings/lead-processing',
        label: 'Lead Processing',
        description: 'Setup steps, daily routine, and repair guidance for forwarded enquiries.',
        icon: Route,
        roles: ['agent'],
        keywords: 'lead processing instructions manual daily routine enquiries repair forwarded portal property24 private property website',
      },
    ],
  },
]
