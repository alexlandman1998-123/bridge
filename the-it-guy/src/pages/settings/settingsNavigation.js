  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Property portals, Meta lead forms, and connected communication channels.',
        icon: PlugZap,
        roles: ['agent'],
        permission: PERMISSIONS.manageWorkspaceSettings,
        keywords: 'property24 private property syndication portal publishing meta facebook instagram lead ads whatsapp communication agency id agent id source reference listings integration exdev production',
      },
    ],
  },
]
