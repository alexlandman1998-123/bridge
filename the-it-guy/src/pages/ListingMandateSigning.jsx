...
export default function ListingMandateSigning() {
  ...
  async function submit(event) {
    ...
    setSubmitting(true)
    const result = await invokeEdgeFunction('listing-mandate-signing', { body: { action: 'sign-pack', token, signedName, signature, acceptedDocuments } })
    setSubmitting(false)
