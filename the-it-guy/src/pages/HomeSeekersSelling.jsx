...
const process = [
  [
    "01",
    "Price it honestly.",
    "We show you the comparable sales and the position your home needs to take from day one.",
  ],
  [
    "02",
    "Launch with a plan.",
  ...
  [
    ...
    "Every viewing, enquiry and buyer response is reported back to you in writing, every week.",
  ],
  [
    "04",
    "Hold us to day 45.",
...
const salePreviews = [
  {
    ...
    record: "Awaiting approved sale record",
  },
  {
    image:
...
export default function HomeSeekersSelling() {
  ...
  useEffect(() => {
    const timer = window.setInterval(
      () => setResultIndex((index) => (index + 1) % salePreviews.length),
      5000,
    );
    ...
    <main className="hs-selling">
      <header className="hs-selling__header">
        ...
        <button
          ...
          className="hs-selling__header-cta"
        >
      ...
      <section className="hs-selling__hero">
        <div className="hs-selling__hero-copy">
          <p className="hs-selling__eyebrow">
            ❯ SELLING WITH <strong>HOME SEEKERS</strong>
          </p>
          ...
          <div className="hs-selling__actions">
            <button
              type="button"
              className="hs-selling__button"
              onClick={() => setValuationOpen(true)}
            >
              Book a free valuation <ArrowRight size={17} />
            </button>
            <a className="hs-selling__text-link" href="#strategy">
              See how we sell <ArrowRight size={16} />
            </a>
          </div>
        </div>
        <div className="hs-selling__hero-visual">
          <img
            src="https://d21tw07c6rnmp0.cloudfront.net/media/uploads/869/pages/2026/8/869_eeb9a8cde79f42729798b3578488dc1e_t_w_1440_h_900.avif"
            alt="A Home Seekers property"
          />
          <div className="hs-selling__day">
            <span>45</span>
            <p>
              Days to prove
              <br />
      ...
      <HomeSeekersFastTrack onValuation={() => setValuationOpen(true)} />

      <section className="hs-selling__strategy" id="strategy">
        <div>
          <p className="hs-selling__eyebrow">
            ❯ THE SELLING <strong>STRATEGY</strong>
          </p>
          <h2>Your home needs more than a listing.</h2>
        </div>
        <div className="hs-selling__strategy-list">
          <article>
            <span>01</span>
            <h3>Evidence before ego.</h3>
            <p>
              We use comparable sales, buyer behaviour and local context to set
              a price that can actually move.
            </p>
          </article>
          <article>
            <span>02</span>
            <h3>Attention with intent.</h3>
            <p>
              Every asset and channel is chosen to make the right buyer stop,
              look and act.
            </p>
          </article>
          <article>
      ...
      <section className="hs-selling__results">
        <div className="hs-selling__results-heading">
          <p className="hs-selling__eyebrow">
            ❯ SALES <strong>ARCHIVE</strong>
          </p>
          <span className="hs-selling__archive-count">
            0{resultIndex + 1}
            <i>/</i>0{salePreviews.length}
          </span>
        ...
        <div className="hs-selling__carousel">
          <div className="hs-selling__sale-stage">
            <img
              key={resultIndex}
              src={activeSale.image}
              alt="Home Seekers sale record preview"
            />
            <strong>SOLD</strong>
            <span>
              CONCLUDED SALE / RECORD {String(resultIndex + 1).padStart(2, "0")}
            </span>
            <div className="hs-selling__next-sale" aria-hidden="true">
              <img src={nextSale.image} alt="" />
              <b>NEXT</b>
            </div>
          </div>
          <div className="hs-selling__sale-record">
            <p>VERIFIED SALE RECORD</p>
            <h3>{activeSale.record}</h3>
            <p className="hs-selling__sale-copy">
              Address, campaign story and verified sale result will populate
              here automatically.
            </p>
      ...
      <section className="hs-selling__process">
        <p className="hs-selling__eyebrow">
      ...
      <section className="hs-selling__valuation" id="valuation">
        <div className="hs-selling__valuation-copy">
          <p className="hs-selling__eyebrow">
        ...
        <div className="hs-selling__valuation-invite">
          <span>01 / FREE VALUATION</span>
          <h3>It takes less than a minute to begin.</h3>
          <p>
            Share the basics. We will come back to you with the right next step.
          </p>
          <button
            type="button"
            className="hs-selling__button hs-selling__button--light"
            onClick={() => setValuationOpen(true)}
          >
