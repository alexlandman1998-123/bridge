...
export function createListingDraftFromSellerLead(lead, options = {}) {
  ...
  if (existingIndex >= 0) {
    ...
    const nextRow = {
      ...
      propertyStructureType: lead?.propertyStructureType || lead?.propertyData?.propertyStructureType || existing?.propertyStructureType || '',
      ...
      bedrooms: Number(lead?.propertyDetails?.bedrooms || lead?.propertyData?.bedrooms || existing?.bedrooms || 0) || null,
      bathrooms: Number(lead?.propertyDetails?.bathrooms || lead?.propertyData?.bathrooms || existing?.bathrooms || 0) || null,
      garages: Number(lead?.propertyDetails?.garages || lead?.propertyData?.garages || existing?.garages || 0) || null,
      parkingBays: Number(lead?.propertyDetails?.parkingBays || lead?.propertyData?.parkingBays || existing?.parkingBays || 0) || null,
      floorSize: Number(lead?.propertyDetails?.floorSize || lead?.propertyData?.floorSize || existing?.floorSize || 0) || null,
      erfSize: Number(lead?.propertyDetails?.erfSize || lead?.propertyData?.erfSize || existing?.erfSize || 0) || null,
      description: lead?.propertyDetails?.description || lead?.propertyData?.description || lead?.description || existing?.description || '',
      propertyDetails: lead?.propertyDetails || existing?.propertyDetails || null,
      features: Array.isArray(lead?.propertyDetails?.features) ? lead.propertyDetails.features : Array.isArray(existing?.features) ? existing.features : [],
      amenities: Array.isArray(lead?.propertyDetails?.amenities) ? lead.propertyDetails.amenities : Array.isArray(existing?.amenities) ? existing.amenities : [],
      marketing: lead?.marketing || existing?.marketing || {},
  ...
  const draft = {
    ...
    propertyStructureType: lead?.propertyStructureType || lead?.propertyData?.propertyStructureType || '',
    ...
    bedrooms: Number(lead?.propertyDetails?.bedrooms || lead?.propertyData?.bedrooms || 0) || null,
    bathrooms: Number(lead?.propertyDetails?.bathrooms || lead?.propertyData?.bathrooms || 0) || null,
    garages: Number(lead?.propertyDetails?.garages || lead?.propertyData?.garages || 0) || null,
    parkingBays: Number(lead?.propertyDetails?.parkingBays || lead?.propertyData?.parkingBays || 0) || null,
    floorSize: Number(lead?.propertyDetails?.floorSize || lead?.propertyData?.floorSize || 0) || null,
    erfSize: Number(lead?.propertyDetails?.erfSize || lead?.propertyData?.erfSize || 0) || null,
    description: lead?.propertyDetails?.description || lead?.propertyData?.description || lead?.description || '',
    propertyDetails: lead?.propertyDetails || null,
    features: Array.isArray(lead?.propertyDetails?.features) ? lead.propertyDetails.features : [],
    amenities: Array.isArray(lead?.propertyDetails?.amenities) ? lead.propertyDetails.amenities : [],
