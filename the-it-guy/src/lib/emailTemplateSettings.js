...
export const DEFAULT_EMAIL_TEMPLATE_SETTINGS = {
  ...
  [EMAIL_TEMPLATE_KEYS.SELLER_ONBOARDING]: {
    ...
    title: 'Complete your seller information',
    preheader:
      'Your agency needs a few details to get your property sale ready.',
    introParagraphs: [
      'Your agency needs a few details from you before your property sale can move ahead.',
    ...
    processSteps: [
      'Complete the secure seller information form.',
      'Have any property or identity documents available if you already have them.',
      'Your agent reviews your answers and contacts you if anything needs to be added or corrected.',
    ],
