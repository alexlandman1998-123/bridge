...
export function createAgentInvite({
  ...
  const invite = {
    ...
    commissionStructureId: String(commissionStructureId || '').trim(),
    commissionStructureName: String(commissionStructureName || '').trim(),
  ...
  const agentRecord = {
    ...
    commissionStructureId: invite.commissionStructureId,
    commissionStructureName: invite.commissionStructureName,
    status: AGENT_INVITE_STATUS.PENDING_INVITE,
    role: invite.role,
