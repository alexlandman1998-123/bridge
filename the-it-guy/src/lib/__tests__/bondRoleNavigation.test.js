...
try {
  ...
  try {
    ...
    assert.deepEqual(
      ...
      ['Dashboard', 'Applications', 'Organisation', 'Consultant Performance', 'Branch Operations', 'Regional Operations', 'HQ Command Centre', 'Bank Relationships', 'Revenue & Commissions', 'Automation & Rules', 'Predictive Intelligence', 'Partners', 'Partner Intelligence', 'Reports', 'Settings'],
    )
    ...
    assert.deepEqual(
      ...
      ['Dashboard', 'Applications', 'Organisation', 'Consultant Performance', 'Branch Operations', 'Regional Operations', 'Bank Relationships', 'Revenue & Commissions', 'Automation & Rules', 'Predictive Intelligence', 'Partner Intelligence'],
    )
    ...
    assert.deepEqual(
      ...
      ['Dashboard', 'Applications', 'Organisation', 'Consultant Performance', 'Branch Operations', 'Bank Relationships', 'Revenue & Commissions', 'Predictive Intelligence', 'Partner Intelligence'],
    )
    ...
    assert.deepEqual(
      ...
      ['Dashboard', 'My Applications', 'Consultant Performance', 'My Commissions', 'Clients', 'Tasks', 'Settings'],
    )
