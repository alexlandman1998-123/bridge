  ...
  bond_originator: [
    { key: 'dashboard', label: 'Dashboard', to: '/dashboard', navSection: 'main' },
    {
      ...
      children: [
        ...
        { key: 'applications_docs', label: 'Awaiting Documents', to: '/applications?queue=missing_documents' },
        { key: 'applications_bank_feedback', label: 'Bank Feedback', to: '/applications?queue=bank_feedback' },
        { key: 'applications_approved', label: 'Approved', to: '/applications?stage=approval_granted' },
        { key: 'applications_declined', label: 'Declined / Blocked', to: '/applications?stage=declined' },
      ],
    },
    {
      key: 'transactions',
      ...
      navSection: 'main',
      children: [
        { key: 'bond_transactions_active', label: 'Active Transactions', to: '/transactions?status=active' },
        { key: 'bond_transactions_awaiting_instruction', label: 'Awaiting Attorney Instruction', to: '/transactions?status=awaiting_instruction' },
        { key: 'bond_transactions_approved', label: 'Bond Approved', to: '/transactions?status=bond_approved' },
        { key: 'bond_transactions_grant_signed', label: 'Grant Signed', to: '/transactions?status=grant_signed' },
        { key: 'bond_transactions_instruction_sent', label: 'Instruction Sent', to: '/transactions?status=instruction_sent' },
        { key: 'bond_transactions_registered', label: 'Registered', to: '/transactions?status=registered' },
        { key: 'bond_transactions_risk', label: 'At Risk', to: '/transactions?status=at_risk' },
      ],
    },
    {
      key: 'clients',
      ...
      navSection: 'main',
      children: [
        { key: 'clients_buyers', label: 'Buyers', to: '/clients' },
        { key: 'clients_companies', label: 'Companies / Trusts', to: '/clients?view=companies' },
        { key: 'clients_contact_history', label: 'Contact History', to: '/clients?view=history' },
      ],
    },
    {
      key: 'documents',
      ...
      children: [
        { key: 'documents_missing', label: 'Missing Documents', to: '/documents?view=missing' },
        { key: 'documents_requested', label: 'Requested', to: '/documents?view=requested' },
        { key: 'documents_review', label: 'Awaiting Review', to: '/documents?view=review' },
        { key: 'documents_completed', label: 'Completed', to: '/documents?view=completed' },
        { key: 'documents_templates', label: 'Templates', to: '/documents?view=templates' },
      ],
    },
    {
      key: 'banks',
      ...
      navSection: 'operations',
      children: [
        { key: 'banks_performance', label: 'Bank Performance', to: '/banks?view=performance' },
        { key: 'banks_submissions', label: 'Submission Stats', to: '/banks?view=submissions' },
        { key: 'banks_approvals', label: 'Approval Rates', to: '/banks?view=approvals' },
        { key: 'banks_turnaround', label: 'Turnaround Times', to: '/banks?view=turnaround' },
        { key: 'banks_contacts', label: 'Bank Contacts', to: '/banks?view=contacts' },
      ],
    },
    {
      key: 'partners',
      ...
      navSection: 'operations',
      children: [
        { key: 'partners_developers', label: 'Developers', to: '/partners?view=developers' },
        { key: 'partners_agents', label: 'Agents', to: '/partners?view=agents' },
        { key: 'partners_attorneys', label: 'Attorneys', to: '/partners?view=attorneys' },
        { key: 'partners_connected', label: 'Connected Partners', to: '/partners?view=connected' },
      ],
    },
    {
      key: 'teams',
      ...
      navSection: 'operations',
      children: [
        { key: 'teams_consultants', label: 'Consultants', to: '/teams?view=consultants' },
        { key: 'teams_processors', label: 'Processors', to: '/teams?view=processors' },
        { key: 'teams_compliance', label: 'Compliance', to: '/teams?view=compliance' },
        { key: 'teams_branches', label: 'Branches', to: '/teams?view=branches' },
        { key: 'teams_regions', label: 'Regions', to: '/teams?view=regions' },
      ],
    },
    {
      key: 'reports',
      ...
      navSection: 'insights',
      children: [
        { key: 'reports_pipeline_performance', label: 'Pipeline Performance', to: '/reports?view=pipeline' },
        { key: 'reports_conversion', label: 'Conversion Rates', to: '/reports?view=conversion' },
        { key: 'reports_team_performance', label: 'Team Performance', to: '/reports?view=team' },
        { key: 'reports_bank_analytics', label: 'Bank Analytics', to: '/reports?view=banks' },
        { key: 'reports_commission', label: 'Revenue / Commission', to: '/reports?view=commission' },
        { key: 'reports_export', label: 'Export Centre', to: '/reports?view=export' },
      ],
    },
    { key: 'performance', label: 'Performance', to: '/performance', navSection: 'insights' },
