...
export const SUBPROCESS_STEP_TEMPLATES = {
  ...
  attorney: [
    ...
    { key: 'fica_received', label: 'FICA Received', sortOrder: 2 },
    { key: 'transfer_documents_prepared', label: 'Transfer Documents Prepared', sortOrder: 3 },
    { key: 'buyer_signed_documents', label: 'Buyer Signed Documents', sortOrder: 4 },
    { key: 'seller_signed_documents', label: 'Seller Signed Documents', sortOrder: 5 },
    { key: 'guarantees_received', label: 'Guarantees Received', sortOrder: 6 },
