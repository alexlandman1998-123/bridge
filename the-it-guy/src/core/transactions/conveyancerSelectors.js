  ...
  return records
    ...
    .map((record) => {
      ...
      return {
        ...
        transactionType: String(record.row?.transaction?.transaction_type || '').toLowerCase(),
        propertyType: String(record.row?.transaction?.property_type || '').toLowerCase(),
        isPrivateMatter: isPrivateMatter(record.row),
