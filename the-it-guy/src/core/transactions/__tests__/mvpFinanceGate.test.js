...
assert.equal(evaluateMvpFinanceGate({ routingProfile: { financeType: 'combination' }, participants: [{ role_type: 'bond_originator' }], documentRequirements: [{ document_key: 'proof_of_funds', status: 'verified' }, { document_key: 'bond_preapproval', status: 'approved' }] }).satisfied, true)
