...
const CANONICAL_MERGE_FIELD_DEFINITIONS = [
  ...
  },
  {
    ...
    label: 'Bridge Legal Logo For Light Backgrounds',
    category: 'Branding',
    description: 'Bridge 9 logo optimized for white or light backgrounds.',
  ...
  },
  {
    ...
    label: 'Bridge Legal Logo For Dark Backgrounds',
    category: 'Branding',
    description: 'Bridge 9 logo optimized for dark backgrounds.',
