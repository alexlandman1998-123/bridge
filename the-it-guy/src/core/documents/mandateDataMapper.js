...
function resolveAgencyProfile(agency = {}, organisation = {}, lead = {}) {
  ...
  return {
    ...
    ffcNumber: firstText(agency.ffcNumber, agency.ffc_number, agency.fidelityFundCertificateNumber, organisation.ffcNumber, organisation.ffc_number, organisation.fidelityFundCertificateNumber, agency.metadata?.ffcNumber, agency.metadata?.ffc_number, organisation.metadata?.ffcNumber, organisation.metadata?.ffc_number),
...
export function mapSellerOnboardingToMandateData(input = {}, legacyLead = {}, legacyAgency = {}, legacyAgent = {}) {
  ...
  const basePlaceholders = {
    ...
    mandatory_disclosure_annexure: propertyDisclosureAnnexure ? safePlaceholder(propertyDisclosureAnnexure.title) : '',
    property_disclosure_annexure: propertyDisclosureAnnexure ? safePlaceholder(propertyDisclosureAnnexure.title) : '',
    mandatory_disclosure_status: propertyDisclosureAnnexure ? safePlaceholder(propertyDisclosureAnnexure.status) : '',
    property_disclosure_status: propertyDisclosureAnnexure ? safePlaceholder(propertyDisclosureAnnexure.status) : '',
    mandatory_disclosure_comments: propertyDisclosureAnnexure ? safePlaceholder(propertyDisclosureAnnexure.comments) : '',
    property_disclosure_comments: propertyDisclosureAnnexure ? safePlaceholder(propertyDisclosureAnnexure.comments) : '',
    mandatory_disclosure_signed_at: propertyDisclosureAnnexure ? safePlaceholder(propertyDisclosureAnnexure.lockedAt || propertyDisclosureAnnexure.locked_at) : '',
    ...
    organisation_legal_name: safePlaceholder(agencyProfile.legalName),
    organisation_trading_name: safePlaceholder(agencyProfile.tradingName || agencyProfile.legalName),
    organisation_registration_number: safePlaceholder(agencyProfile.registrationNumber),
    organisation_vat_number: safePlaceholder(agencyProfile.vatNumber),
    organisation_registered_address: safePlaceholder(agencyProfile.address),
    organisation_fsp_number: safePlaceholder(agencyProfile.fspNumber),
    organisation_ffc_number: safePlaceholder(agencyProfile.ffcNumber),
