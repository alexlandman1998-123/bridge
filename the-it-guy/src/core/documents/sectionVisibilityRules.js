...
const FIELD_ALIAS_MAP = {
  ...
  property_title_type: ['property_title_type', 'property.title_type_raw', 'property.title_type'],
  'property.title_type_raw': ['property.title_type_raw', 'property_title_type', 'property.title_type'],
