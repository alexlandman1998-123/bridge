...
const MANDATE_SECTION_DEFINITIONS = [
  ...
  createPacketSection({
    ...
    placeholders: [
      ...
      ['organisation_trading_name', 'Organisation Trading Name'],
    ],
  }),
  createPacketSection({
    key: 'property_details',
...
export function resolveOtpPacketPlaceholders({
  ...
  return {
    ...
    organisation_trading_name: normalizeNullableText(organisationProfile.displayName || organisationProfile.display_name || organisationProfile.tradingName || organisationProfile.trading_name || organisationProfile.name || agencyProfile.tradingName || agencyProfile.trading_name || agencyProfile.name),
    organisation_name: normalizeNullableText(organisationProfile.displayName || organisationProfile.display_name || organisationProfile.tradingName || organisationProfile.trading_name || organisationProfile.name || agencyProfile.tradingName || agencyProfile.trading_name || agencyProfile.name),
    organisation_legal_name: normalizeNullableText(agencyProfile.legalName || agencyProfile.legal_name || organisationProfile.legalName || organisationProfile.legal_name),
    ...
    organisation_registration_number: normalizeNullableText(agencyProfile.registrationNumber || agencyProfile.registration_number || agencyProfile.companyRegistrationNumber || organisationProfile.registrationNumber || organisationProfile.registration_number || organisationProfile.companyRegistrationNumber),
    ...
    organisation_vat_number: normalizeNullableText(agencyProfile.vatNumber || agencyProfile.vat_number || organisationProfile.vatNumber || organisationProfile.vat_number),
    ...
    organisation_registered_address: normalizeNullableText(agencyProfile.address || agencyProfile.physicalAddress || agencyProfile.physical_address || organisationProfile.address || organisationProfile.physicalAddress || organisationProfile.physical_address),
    ...
    organisation_fsp_number: normalizeNullableText(agencyProfile.fspNumber || agencyProfile.fsp_number || organisationProfile.fspNumber || organisationProfile.fsp_number || agencyMetadata.fspNumber || agencyMetadata.fsp_number),
    ...
    organisation_ffc_number: normalizeNullableText(agencyProfile.ffcNumber || agencyProfile.ffc_number || organisationProfile.ffcNumber || organisationProfile.ffc_number || agencyMetadata.ffcNumber || agencyMetadata.ffc_number),
    ...
    mandatory_disclosure_annexure: normalizeNullableText(disclosureAnnexure?.title),
    property_disclosure_annexure: normalizeNullableText(disclosureAnnexure?.title),
    mandatory_disclosure_status: normalizeNullableText(disclosureAnnexure?.status),
    property_disclosure_status: normalizeNullableText(disclosureAnnexure?.status),
    mandatory_disclosure_comments: normalizeNullableText(disclosureAnnexure?.comments),
    property_disclosure_comments: normalizeNullableText(disclosureAnnexure?.comments),
    mandatory_disclosure_signed_at: normalizeNullableText(disclosureAnnexure?.lockedAt || disclosureAnnexure?.locked_at),
