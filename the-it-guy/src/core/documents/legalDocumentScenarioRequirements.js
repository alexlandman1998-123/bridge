...
export function buildLegalDocumentRequirementDraftFromPlaceholders(placeholders = {}) {
  ...
  return {
    ...
    buyerFullName: firstValue(source, ['buyer_full_name', 'buyer_name', 'buyer.person.full_name', 'buyer.person.name', 'buyer.company.name', 'buyer.company.company_name', 'buyer.trust.name', 'buyer.trust.trust_name']),
    buyerIdNumber: firstValue(source, ['buyer_id_number', 'buyer.person.identity_number_or_passport_number', 'buyer.person.identity_number', 'buyer.person.passport_number', 'buyer_company_registration_number', 'buyer.company.registration_number', 'buyer.company.company_registration_number', 'buyer_trust_registration_number', 'buyer.trust.registration_number', 'buyer.trust.trust_registration_number']),
    buyerMaritalRegime: firstValue(source, ['buyer_marital_status', 'buyer_marital_regime', 'buyer.person.marital_status', 'buyer.person.marital_regime']),
    buyerRepresentativeName: firstValue(source, ['buyer_representative_name', 'buyer.company.authorised_signatory.name', 'buyer.company.authorized_signatory.name', 'buyer.trust.authorised_trustee.name', 'buyer.trust.authorized_trustee.name']),
    buyerRepresentativeCapacity: firstValue(source, ['buyer_representative_capacity', 'buyer.company.authorised_signatory.capacity', 'buyer.company.authorized_signatory.capacity', 'buyer.trust.authorised_trustee.capacity', 'buyer.trust.authorized_trustee.capacity']),
    buyerResolutionDate: firstValue(source, ['buyer_resolution_date', 'buyer.company.resolution_date', 'buyer.trust.resolution_date']),
    buyerTrusteeNames: firstValue(source, ['buyer_trustee_names', 'buyer.trust.trustees']),
    buyerAuthorityBasis: firstValue(source, ['buyer_authority_basis', 'buyer.company.authority_basis', 'buyer.trust.authority_basis']),
    buyerSpouseFullName: firstValue(source, ['buyer_spouse_full_name', 'buyer.person.spouse_full_name']),
    buyerSpouseIdNumber: firstValue(source, ['buyer_spouse_id_number', 'buyer.person.spouse_identity_number', 'buyer.person.spouse_id_number']),
    buyerSpouseEmail: firstValue(source, ['buyer_spouse_email', 'buyer.person.spouse_email']),
