...
export const BUYER_TYPE_ALIASES = createAliasMap({
  ...
  close_corporation: ['cc', 'close_corp'],
  trust: ['family_trust'],
  foreign_purchaser: ['foreign', 'foreign_individual', 'foreign_buyer', 'non_resident', 'non-resident'],
  power_of_attorney: ['poa', 'buyer_poa', 'attorney'],
  deceased_estate: ['deceased', 'estate', 'estate_late'],
  minor: ['under_18', 'child_buyer'],
  insolvent: ['sequestrated', 'insolvency'],
  curatorship: ['administration', 'administrator', 'curator'],
  business_rescue: ['business_rescue_buyer', 'company_in_business_rescue'],
  liquidation: ['liquidated_company', 'company_liquidation', 'liquidation_buyer'],
...
export const SELLER_TYPE_ALIASES = createAliasMap({
  ...
  close_corporation: ['cc', 'close_corp'],
  trust: ['family_trust'],
  minor: ['under_18', 'child_owner'],
  insolvent: ['sequestrated', 'insolvency', 'insolvent_estate'],
  curatorship: ['administration', 'administrator', 'curator'],
  business_rescue: ['business_rescue_seller', 'company_in_business_rescue'],
  liquidation: ['liquidated_company', 'company_liquidation'],
  deceased_estate: ['deceased', 'estate', 'estate_late'],
...
export const OWNERSHIP_STRUCTURE_ALIASES = createAliasMap({
  ...
  close_corporation: ['cc', 'close_corp'],
  trust: ['family_trust'],
  minor: ['under_18', 'child_owner', 'child_buyer'],
  insolvent: ['sequestrated', 'insolvency', 'insolvent_estate'],
  curatorship: ['administration', 'administrator', 'curator'],
  business_rescue: ['business_rescue_buyer', 'business_rescue_seller', 'company_in_business_rescue'],
  liquidation: ['liquidated_company', 'company_liquidation', 'liquidation_buyer'],
  deceased_estate: ['deceased', 'estate', 'estate_late'],
  power_of_attorney: ['poa', 'attorney'],
