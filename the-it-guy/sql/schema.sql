...
drop policy if exists client_portal_contexts_demo_all on client_portal_contexts;
create policy client_portal_contexts_demo_all on client_portal_contexts
for all to anon, authenticated
using (true)
with check (true);

drop policy if exists client_seller_interest_requests_demo_all on client_seller_interest_requests;
create policy client_seller_interest_requests_demo_all on client_seller_interest_requests
for all to anon, authenticated
using (true)
with check (true);
