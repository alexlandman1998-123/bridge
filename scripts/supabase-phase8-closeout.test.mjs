...
assert.equal(result.rawManifestRowCount, 33)
assert.equal(result.manifestRowCount, 32)
...
assert.equal(result.evidence.complete.length + result.evidence.incomplete.length, 32)
