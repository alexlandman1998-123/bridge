...
assert.equal(result.rawManifestRowCount, 25)
assert.equal(result.manifestRowCount, 21)
...
assert.equal(result.evidence.complete.length + result.evidence.incomplete.length, 21)
