...
assert.equal(result.manifestRowCount, manifest.rows.length)
...
assert.equal(result.evidence.complete.length + result.evidence.incomplete.length, manifest.rows.length)
