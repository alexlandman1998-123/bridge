...
assert.equal(evidence.safety.applicationManuallyPromotedByPhase21, false)
assert.equal(evidence.safety.automaticProductionDeploymentTriggeredByPush, true)
assert.equal(evidence.safety.observedProductionDeploymentStatus, 'READY')
assert.equal(evidence.safety.liveReleaseIdAfterPush, '785b7ef1365d1b7f8fefe4bb8865da3648607a6b')
