...
assert.match(source, /Phase 12 baseline plus reviewed promotions/)
assert.match(source, /productionLedgerRecorded === true/)
assert.match(source, /expectedProductionLedgerCount/)
