 ...
 */
export function selectWebsiteLogo(site: Pick<ResolvedSite, 'logoUrl' | 'logoLightUrl' | 'logoDarkUrl' | 'experienceKey'>, darkBackground = false): string | undefined {
  ...
  if (site.experienceKey === 'editorial-property-v1') return '/images/lwp-logo-white-transparent.png'
