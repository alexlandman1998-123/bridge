...
comment on function public.bridge_client_portal_matter_financial_accounts(text) is
  'Token-scoped read model for buyer/seller portal account details. Only portal-enabled accounts, published documents, and client-visible posted entries are returned.';
