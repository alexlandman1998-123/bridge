-- Corrective migration for non-runnable row 202607220007.
-- Reconciles the Phase 4 legal runtime metadata immutability function under a
-- new reviewed version because the historical migration is already partially live.
