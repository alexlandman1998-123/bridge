-- The high-contrast organisation logo is the approved mark for public dark
-- hero surfaces. Expose only public visual identity fields through the
-- already-public landing RPC.
