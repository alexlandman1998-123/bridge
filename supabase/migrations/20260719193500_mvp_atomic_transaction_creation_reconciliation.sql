-- Staging-only historical reconciliation for the MVP atomic transaction path.
--
-- Do not replay 202607180046. That migration is absent from staging and is not
-- standalone-safe there: it omits transactions.mandate_packet_id, does not
