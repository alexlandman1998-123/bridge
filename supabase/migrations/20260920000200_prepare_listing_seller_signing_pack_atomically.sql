-- Phase 2: signing-pack lineage and sessions are one database transaction.
-- Email delivery deliberately happens after this preparation step so delivery
-- failure cannot leave a replacement/amendment record without usable sessions.
