-- Restore the JSONB document selection contract after the branding-lineage
-- migration inadvertently replaced this function with an older text[] body.
-- Keep the branding lineage validation introduced by that later migration.
