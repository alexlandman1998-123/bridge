-- Keep the persisted completed-document labels consistent with the mandate
-- type frozen in the signing pack. This overrides the earlier generic
-- "Exclusive mandate" label used by the signing completion function.
