...
export function extractEmailBrandingFromPayload(
  ...
  return {
    ...
    logoLightUrl: firstText(
      ...
      payload.logoLight,
      payload.logo_light,
      payload.organisationLogoLightUrl,
      payload.organisation_logo_light_url,
      metadata.logoLightUrl,
      metadata.logo_light_url,
      metadata.logoLight,
      metadata.logo_light,
      metadata.organisationLogoLightUrl,
      metadata.organisation_logo_light_url,
    ) || undefined,
    logoDarkUrl: firstText(
      payload.logoDarkUrl,
      payload.logo_dark_url,
      ...
      metadata.logoDark,
      metadata.logo_dark,
      metadata.organisationLogoDarkUrl,
      metadata.organisation_logo_dark_url,
    ) || undefined,
    logoIconUrl: firstText(
...
export function extractEmailBrandingFromOrganisation(
  ...
  return {
    ...
    logoLightUrl: firstText(row.logo_light_url, row.logoLightUrl) ||
      undefined,
    logoDarkUrl: firstText(row.logo_dark_url, row.logoDarkUrl) || undefined,
    logoIconUrl:
