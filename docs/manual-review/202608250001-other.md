...
Stream: `other`
Original file: `202608250001_remove_listing_mandate_activation_guards.sql`
...
- Idempotency: DROP TRIGGER/FUNCTION IF EXISTS removes superseded mandate activation guards without changing stored rows.
