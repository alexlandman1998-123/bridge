...
Stream: `other`
Original file: `20260830160810_secure_auth_bootstrap_rpc.sql`
...
- Idempotency: CREATE OR REPLACE secure bootstrap RPC is definition-only; grants are deterministic.
