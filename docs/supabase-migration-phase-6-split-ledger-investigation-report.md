...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| commercial | 5 | 5 | 0 | 0 | 0 | 5 | 0 | 0 |
| lead_capture_crm | 4 | 4 | 0 | 0 | 0 | 4 | 0 | 0 |
| workspace_platform | 4 | 4 | 0 | 0 | 0 | 4 | 0 | 0 |
| bond_finance | 1 | 0 | 0 | 0 | 1 | 1 | 0 | 1 |
| notification_automation | 1 | 1 | 0 | 0 | 0 | 1 | 0 | 0 |
| other | 1 | 0 | 1 | 0 | 0 | 1 | 0 | 1 |
| transaction_network | 1 | 1 | 0 | 0 | 0 | 1 | 0 | 0 |

## Object Review Required

| Version | Module | Local File | Object Status | Objects Live | Recommendation |
| --- | --- | --- | --- | --- | --- |
| 202606090010 | other | 202606090010_created_by_access_remediation.sql | partial_live | 27/30 | Do not batch repair; inspect missing/partial objects first. |

## Manual SQL Review

| Version | Module | Local File | Reason | Recommendation |
| --- | --- | --- | --- | --- |
| 202606050001 | bond_finance | 202606050001_bond_bank_relationship_profiles.sql | no_static_objects | Manual SQL review needed because no static catalog objects were extracted. |
...
| 202606050001 | bond_finance | 202606050001_bond_bank_relationship_profiles.sql | bond_bank_relationship_profiles | remote_name_matches | no_static_objects | n/a | 1 | manual_sql_review |
...
| 202606090010 | other | 202606090010_created_by_access_remediation.sql | created_by_access_remediation | remote_name_matches | partial_live | 27/30 | 63 | object_review_required |
...
Exclude split rows from any ledger repair batch. Review the object-review/manual rows first, then continue with small pure-local-only batches from Phase 5 that have module smoke evidence.
