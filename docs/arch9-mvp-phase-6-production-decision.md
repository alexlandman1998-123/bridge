...
7. Production-pilot support readiness, with the approved owners, an incident log, escalation runbook, response target, and explicit authority to stop the batch.
...
```json
{
  ...
  "preparedBy": "support.owner@arch9.example",
  "preparedAt": "2026-07-19T00:00:00.000Z",
  "pilotOwner": "operations.owner@arch9.example",
  "supportOwner": "support.owner@arch9.example",
  "rollbackOwner": "engineering.owner@arch9.example",
  "supportChannel": "pilot-support@arch9.example",
  "incidentLogReference": "operations/pilot-incidents",
  "escalationRunbookReference": "docs/mvp-pilot-escalation.md",
  "stopAuthority": "operations.owner@arch9.example",
  "incidentRecordingEnabled": true,
