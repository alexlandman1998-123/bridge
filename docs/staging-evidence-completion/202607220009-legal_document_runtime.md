...
Version: `202607220009`
Stream: `legal_document_runtime`
Route: `apply_original`
File: `202607220009_phase4_legal_release_provenance.sql`
Evidence: `docs/staging-evidence/202607220009-legal_document_runtime.json`
Status: Complete

## Commands

```bash
node scripts/supabase-phase6-staging-execution.mjs --apply-sql --version 202607220009 --confirm APPLY_TO_STAGING_ONLY --phase1-receipt the-it-guy/config/legal-document-rollout-phase1-staging.json --phase1-receipt-digest sha256:08917a8cd139538cdf40f4f2eafd60acf351ba6efd6d0ea7c14fc21206581303
```
