...
Version: `202607220008`
Stream: `legal_document_runtime`
Route: `apply_original`
File: `202607220008_phase4_legal_template_release_integrity.sql`
Evidence: `docs/staging-evidence/202607220008-legal_document_runtime.json`
Status: Complete

## Commands

```bash
node scripts/supabase-phase6-staging-execution.mjs --apply-sql --version 202607220008 --confirm APPLY_TO_STAGING_ONLY --phase1-receipt the-it-guy/config/legal-document-rollout-phase1-staging.json --phase1-receipt-digest sha256:08917a8cd139538cdf40f4f2eafd60acf351ba6efd6d0ea7c14fc21206581303
```
